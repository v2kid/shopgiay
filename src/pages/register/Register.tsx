              ...
              <div>
                  ...
                  <div className='mb-5 w-1/2 px-3'>
                    ...
                    <div className='flex'>
                      <div className='pointer-events-none z-10 flex w-10 items-center justify-center pl-1 text-center'>
                        <i className='mdi mdi-account-outline text-lg text-gray-400' />
                      </div>
                      <input
                        type='text'
                ...
                <div className='-mx-3 flex'>
                  <div className='mb-5 w-full px-3'>
                    ...
                    <div className='flex'>
                      <div className='pointer-events-none z-10 flex w-10 items-center justify-center pl-1 text-center'>
                        <i className='mdi mdi-email-outline text-lg text-gray-400' />
                      </div>
                      <input
                        type='email'
                        className='-ml-10 w-full rounded-lg border-2 border-gray-200 py-2 pl-10 pr-3 outline-none focus:border-indigo-500'
                ...
                <div className='-mx-3 flex'>
                  <div className='mb-12 w-full px-3'>
                    ...
                    <div className='flex'>
                      <div className='pointer-events-none z-10 flex w-10 items-center justify-center pl-1 text-center'>
                        <i className='mdi mdi-lock-outline text-lg text-gray-400' />
                      </div>
                      <input
                        type='password'
                        className='-ml-10 w-full rounded-lg border-2 border-gray-200 py-2 pl-10 pr-3 outline-none focus:border-indigo-500'
