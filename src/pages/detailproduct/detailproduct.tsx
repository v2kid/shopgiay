...
import Related from "pages/blog/components/Related/Related";
import { useAddtocartMutation, useGetproductdetailQuery } from "pages/service/page.service";
...
export default function DetailProduct(){
  const {id} = useParams();
   ...
   const [mainImg, setMainImage] = useState(0)
   ...
   const handleAddToCart = async () => {
    try {
      ...
      // Handle error
      toast.warning('Đã có trong giỏ hàng')
    }
  };
  ...
  <div className="card">
    ...
    <div className="product-imgs">
      <div className="img-display">
          <img  src={data.imageUrl[mainImg]} alt="shoe image" />
      </div>
      <div className=" grid grid-cols-4 mt-2">
           {data.imageUrl.map((imageUrl, index) => (
             <img
              className='gridlist object-cover h-32 w-32'
               key={index}
               src={imageUrl}
              alt={`Image ${index}`}
    ...
    <div className="product-content mt-5">
      ...
      <a href="#" className="product-link">{data.brand}</a>
